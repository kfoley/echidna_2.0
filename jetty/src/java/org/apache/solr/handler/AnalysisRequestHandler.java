...
public class AnalysisRequestHandler extends RequestHandlerBase {
  ...
  public String getVersion() {
    return "$Revision: 1052743 $";
  }

  @Override
  public String getSourceId() {
    return "$Id: AnalysisRequestHandler.java 1052743 2010-12-25 02:51:46Z yonik $";
  }

  @Override
  public String getSource() {
    return "$URL: http://svn.apache.org/repos/asf/lucene/dev/trunk/solr/src/java/org/apache/solr/handler/AnalysisRequestHandler.java $";
  }
